...
#define  CPU_CFG_DATA_SIZE              CPU_WORD_SIZE_08        /* Defines CPU data    word size.                       */
...
#define  CPU_CRITICAL_ENTER()    _CLI()                         /* Disable interrupts                                   */
#define  CPU_CRITICAL_EXIT()     _SEI()                         /* Enable  interrupts                                   */
#endif

#if     (CPU_CFG_CRITICAL_METHOD == CPU_CRITICAL_METHOD_STATUS_STK)
#define  CPU_CRITICAL_ENTER()    _OPC(0x930A);_OPC(0xB70F);_CLI();_OPC(0x930F);_OPC(0x9109)
#define  CPU_CRITICAL_EXIT()     _OPC(0x930A);_OPC(0x910F),_OPC(0xBF0F);_OPC(0x9109)
#endif
