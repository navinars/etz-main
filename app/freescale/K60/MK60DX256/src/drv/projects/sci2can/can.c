...
{
      pFlexCANReg->CTRL1 |= FLEXCAN_CTRL_BOFF_MSK;  
}
...
{
      pFlexCANReg->CTRL1 |= FLEXCAN_CTRL_ERR_MSK;  
}
...
{
      pFlexCANReg->CTRL1 |= FLEXCAN_CTRL_TWRN_MSK;  
}
...
{
      pFlexCANReg->CTRL1 |= FLEXCAN_CTRL_RWRN_MSK;  
}
...
{
      pFlexCANReg->MCR |= FLEXCAN_MCR_WAK_MSK;  
}
...
void    FlexCAN_EnableIMEU_Interrupt(void)
{
      pFlexCANReg->CTRL2 |= FLEXCAN_CTRL2_IMEUMASK;  
}

void    FlexCAN_DisableIMEU_Interrupt(void)
{
      pFlexCANReg->CTRL2 &= ~FLEXCAN_CTRL2_IMEUMASK;  
}

void    FlexCAN_EnableLostRx_Interrupt(void)
{
      pFlexCANReg->CTRL2 |= (FLEXCAN_CTRL2_LOSTRLMSK | FLEXCAN_CTRL2_LOSTRMMSK) ;  
}

void    FlexCAN_DisableLostRx_Interrupt(void)
{
      pFlexCANReg->CTRL2 &= ~(FLEXCAN_CTRL2_LOSTRLMSK | FLEXCAN_CTRL2_LOSTRMMSK);  
}
