...
#define  PROBE_RS232_CFG_TASK_PRIO                         7    /*  Configure parse task priority   (see Note #2a).     */
#define  PROBE_RS232_CFG_TASK_STK_SIZE                   300    /*  Configure parse task stack size (see Note #2b).     */
...
#define  PROBE_TCPIP_CFG_TASK_PRIO                         8    /*  Configure parse task priority   (see Note #2a).     */
...
#define  PROBE_USB_CFG_TASK_PRIO                           9    /*  (c) Set task priority.                              */
