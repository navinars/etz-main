...
#define CC2520_GPIO0_DIR_OUT()
#define CC2520_GPIO1_DIR_OUT()          GPIOPinTypeGPIOInput(GPIO_PORTD_BASE, GPIO_PIN_0)
#define CC2520_GPIO2_DIR_OUT()          GPIOPinTypeGPIOInput(GPIO_PORTD_BASE, GPIO_PIN_1)
#define CC2520_GPIO3_DIR_OUT()          GPIOPinTypeGPIOInput(GPIO_PORTD_BASE, GPIO_PIN_2)
#define CC2520_GPIO4_DIR_OUT()          GPIOPinTypeGPIOInput(GPIO_PORTD_BASE, GPIO_PIN_3)
#define CC2520_GPIO5_DIR_OUT()
